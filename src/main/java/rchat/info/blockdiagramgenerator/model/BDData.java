...
public class BDData extends BDElement {
    public BDData(DiagramBlockController context, String data) {
    ...
    public void drawElement(Pair<Double, Double> drawPoint) {
        ...
        gc.strokePolygon(new double[]{(drawPoint.getKey() + context.model.posX) * context.model.canvasScale,
                                      (drawPoint.getKey() + context.model.posX) * context.model.canvasScale + textHeight / 4,
                                      (drawPoint.getKey() + context.model.posX) * context.model.canvasScale + totalWidth,
                                      (drawPoint.getKey() + context.model.posX) * context.model.canvasScale + totalWidth - textHeight / 4,
                                      (drawPoint.getKey() + context.model.posX) * context.model.canvasScale},
                         new double[]{(drawPoint.getValue() + context.model.posY) * context.model.canvasScale + textHeight,
                                      (drawPoint.getValue() + context.model.posY) * context.model.canvasScale,
                                      (drawPoint.getValue() + context.model.posY) * context.model.canvasScale,
                                      (drawPoint.getValue() + context.model.posY) * context.model.canvasScale + textHeight,
                                      (drawPoint.getValue() + context.model.posY) * context.model.canvasScale + textHeight}, 5);
