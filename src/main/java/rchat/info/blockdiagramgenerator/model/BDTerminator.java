...
public class BDTerminator extends BDElement {
    public BDTerminator(DiagramBlockController context, String data) {
    ...
    public void drawElement(Pair<Double, Double> drawPoint) {
        ...
        gc.strokeRoundRect((drawPoint.getKey() + context.model.posX) * context.model.canvasScale, (drawPoint.getValue() + context.model.posY) * context.model.canvasScale, totalWidth, textHeight, textHeight, textHeight);
